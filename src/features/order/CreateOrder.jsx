      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 md:flex-row md:items-center">
          ...
          <div className="grow">
            ...
            {formErrors?.phone && (
              <p className="mt-2 rounded-lg bg-red-100 px-6 py-1.5 text-xs text-red-700">
                {formErrors.phone}
              </p>
            )}
          </div>
        ...
        <div className="mb-12 flex items-center gap-5">
          <input
            className="h-6 w-6 cursor-pointer accent-yellow-400 focus:outline-none focus-visible:ring focus-visible:ring-yellow-400 focus-visible:ring-offset-2"
            type="checkbox"
            name="priority"
            id="priority"
            value={withPriority}
